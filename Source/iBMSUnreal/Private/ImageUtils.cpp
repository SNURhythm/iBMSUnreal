...
void ImageUtils::LoadTexture2D(const FString& ImagePath, bool& IsValid, int32 TargetWidth, int32 TargetHeight, UTexture2D*& OutTexture)
{
	IsValid = false;
	IImageWrapperModule& ImageWrapperModule = FModuleManager::LoadModuleChecked<IImageWrapperModule>(FName("ImageWrapper"));
	TSharedPtr<IImageWrapper> ImageWrapper = ImageWrapperModule.CreateImageWrapper(ImagePath.EndsWith(".png") ? EImageFormat::PNG : (ImagePath.EndsWith(".bmp")? EImageFormat::BMP : EImageFormat::JPEG));
